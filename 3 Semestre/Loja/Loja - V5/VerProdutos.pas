...
if ComboBox2.text = 'Componentes e peças' then
pesquisa:= 'categoria = "Componentes e peças" and';

if ComboBox2.text = 'Armazenamento de dados' then
pesquisa:= 'categoria = "Armazenamento de dados" and';

if ComboBox2.text = 'Acessórios e periféficos' then
pesquisa:= 'categoria = "Acessórios e periféficos" and';
